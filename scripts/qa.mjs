...
check(inventoryWorkflow.includes("workflow_dispatch:"), "full inventory workflow must retain manual dispatch");
check(inventoryWorkflow.includes("schedule:"), "full inventory workflow must have an automatic schedule");
check(inventoryWorkflow.includes('cron: "17 18 * * *"'), "full inventory workflow must use the expected daily JST schedule");
